...
use Modules\Auth\Entities\KelompokPekerjaan;
...
class HalJenisPekerjaanController extends Controller
{
    ...
    public function halamanPekerjaan()
    {
        ...
        //dd($j_pemohon);
        return view('auth::master_data.jenis_pekerjaan.halaman_jenis_pekerjaan', compact('j_pekerjaan'));
    }
    ...
    {
        return view('auth::master_data.jenis_pekerjaan.halaman_tambah_jenis_pekerjaan');
    }
    ...
    public function editPekerjaan($id)
    {
        ...
        return view('auth::master_data.jenis_pekerjaan.halaman_edit_jenis_pekerjaan', compact('id', 'j_pekerjaan'));
    }
