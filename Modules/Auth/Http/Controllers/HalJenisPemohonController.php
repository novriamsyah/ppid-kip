...
class HalJenisPemohonController extends Controller
{
    ...
    public function halamanPemohon()
    {
        ...
        //dd($j_pemohon);
        return view('auth::master_data.jenis_pemohon.halaman_jenis_pemohon', compact('j_pemohon'));
    }
    ...
    {
        return view('auth::master_data.jenis_pemohon.halaman_tambah_jenis_pemohon');
    }
