...
namespace Modules\Identitas\Http\Controllers;
...
use Modules\Identitas\Entities\JenisIdentitas;
...
{/**
    ...
    public function halamanIdentitas()
    {
        ...
        // dd($j_identitas);
        return view('identitas::master_data.jenis_identitas.halaman_jenis_identitas', compact('j_identitas'));
    }
    ...
    public function tambahIdentitas()
    {
        ...
        return view('identitas::master_data.jenis_identitas.halaman_tambah_jenis_identitas', compact('j_pemohon'));
    }
    ...
    public function editIdentitas($id)
    {
        ...
        return view('identitas::master_data.jenis_identitas.halaman_edit_jenis_identitas', compact('id', 'j_pemohon', 'j_identitas'));
    }
