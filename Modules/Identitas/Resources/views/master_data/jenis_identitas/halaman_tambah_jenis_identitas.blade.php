                        ...
                        <div class="row">
                            <div class="col-xl-12">
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" class="form-control" id="val-jenis_identitas" name="jenis_identitas"  placeholder="Masukan Jenis Identitas" required style="border: 1px solid #000000">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-lg-8">
                                        <select class="default-select wide form-control" id="val-id_jenis_pemohon" name="id_jenis_pemohon" style="border: 1px solid #000000">
                                ...
                                <div class="col-lg-10 ms-auto">
                                    <a href="{{url('/simpan_identitas')}}"><button type="submit" class="btn btn-primary">Tambah data</button></a>
                                </div>
                                </div>
                            </div>
                        </div>
