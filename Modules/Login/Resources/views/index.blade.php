	...
	<div class="container ">
		<div class="row p-5">
			...
			<div class="col-md shadow p-3 bg-white rounded">
                ...
                @endif
				<form action="{{ route('login.verifikasi') }}" method="POST" name="form_login">
                    @csrf
					<div class="mb-3">
  ...
  <div class="modal fade bd-example-modal-sm" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-sm">
      <div class="modal-content p-4">
        <p style="font-size: 1rem; font-weight:bold;">Request Reset Password</p>
        <div class="mb-3">
          <input type="email" placeholder="Email address" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
        </div>
        <button class="btn mb-1" type="button" style="background-color:#ba131a ;">Submit</button>
