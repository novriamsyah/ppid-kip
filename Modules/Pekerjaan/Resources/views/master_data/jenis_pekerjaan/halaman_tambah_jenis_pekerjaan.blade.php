                        ...
                        <div class="row">
                            <div class="col-xl-12">
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="text" class="form-control input-default" id="val-jenis_kerja" name="jenis_kerja"  placeholder="Masukan Jenis Pekrjaan" required style="border: 1px solid #000000">
