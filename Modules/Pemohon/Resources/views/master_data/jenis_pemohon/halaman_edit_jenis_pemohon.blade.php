                        ...
                        <div class="row">
                            <div class="col-xl-12">
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" class="form-control" id="val-jenis_pemohon" name="jenis_pemohon"  placeholder="Masukan jenis pemohon" value="{{$j_pemohon->jenis_pemohon}}" required style="border: 1px solid #000000">
